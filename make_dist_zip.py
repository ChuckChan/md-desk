#!/usr/bin/env python
"""Distribution ZIP builder for MdDesk v0.1.0 RC.
...
OUT = os.path.join(BASE, "MdDesk-v0.1.0-RC-Windows-x64.zip")
ROOT = "MdDesk-v0.1.0-RC"
...
def main():
    for p in (SRC_DIST, RELEASE_MD, README_TXT):
