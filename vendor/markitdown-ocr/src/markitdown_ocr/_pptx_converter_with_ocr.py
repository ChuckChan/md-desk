        ...
        for slide in presentation.slides:
            ...
            def get_shape_content(shape, **kwargs):
                ...
                if self._is_picture(shape):
                    ...
                    # Format extracted content. ocr_block is already a full
                    # marked block (success *[Image OCR]... or error
                    # *[OCR Error]...). llm_description, if present, is plain
                    # descriptive text from the built-in image-description path.
                    content = (llm_description or ocr_block or "").strip()
                    if content:
                        md_content += f"\n{content}\n"
